...
from flask_serverinfo import __version__, __doc__
...
properties = dict(
    name = 'Flask-ServerInfo',
    version = __version__,
    url = 'https://github.com/salsita/flask-serverinfo',
    download_url = 'https://github.com/salsita/flask-serverinfo/tarball/v{}'.format( __version__),
